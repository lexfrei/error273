...
What goes up is voted on. Each citizen casts one voice for whatever answers whichever of their own needs went worst since the last ballot -- a house for rest, a hut for hunger, a boiler for cold -- and the highest tally wins, with ties resolved in a fixed order so the same colony always decides the same way. It is the worst of the season rather than the state at the moment of the vote, because a hauler who was frozen at first light and warm again by evening has still been frozen. With every bed taken the colony builds a house regardless: that one is not a preference but the precondition for growing at all.
